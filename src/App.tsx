    ...
    <>
      <div className='flex flex-wrap justify-center gap-6 m-5'>
        {students.map((student) => {
          return(
            <div key={student._id} className=' p-2 bg-slate-100 flex rounded-md place-items-center  transition-all duration-500 hover:scale-105 hover:shadow-2xl cursor-pointer' >
